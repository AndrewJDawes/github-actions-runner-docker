...
# AMD64
eval_cmd_amd="${eval_cmd_base}-amd64 --build-arg ARCH=amd64/ --build-arg RUNNER_ARCH=x64 ."
...
eval_cmd_arm32v7="${eval_cmd_base}-arm32v7 --build-arg ARCH=arm32v7/ --build-arg RUNNER_ARCH=arm ."
...
eval_cmd_arm64v8="${eval_cmd_base}-arm64v8 --build-arg ARCH=arm64v8/ --build-arg RUNNER_ARCH=arm64 ."
